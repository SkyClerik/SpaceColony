...
namespace Gameplay
{
    public class DungeonEvents : Singleton<DungeonEvents>
    {
        ...
        {
            Debug.Log($"[Event] Машина достигла {destination.name}", carBehavior.gameObject);
        ...
        {
            Debug.Log($"[Event] Начало выполнения задания");
        ...
        {
            Debug.Log($"[Event] Задание выполнено");
